...
public class SDKCasePrivateDefConstructor extends StdLogEntry {
    String code;
    String errorMessage;
    ...
    private SDKCasePrivateDefConstructor() {
        throw new RuntimeException("This is a bad constructor");
    }

    public SDKCasePrivateDefConstructor(SDKCasePrivateDefConstructor accstdErrors) {
    ...
    @Override
    public SDKCasePrivateDefConstructor copy() {
        return new SDKCasePrivateDefConstructor(this);
    }
