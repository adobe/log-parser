...
public class SDKCaseBadDefConstructor extends StdLogEntry {
    String code;
    String errorMessage;
    ...
    public SDKCaseBadDefConstructor() {
        throw new RuntimeException("This is a bad constructor");
    }

    public SDKCaseBadDefConstructor(SDKCaseBadDefConstructor accstdErrors) {
    ...
    @Override
    public SDKCaseBadDefConstructor copy() {
        return new SDKCaseBadDefConstructor(this);
    }
