...
public class ParseTesting {
        ...
        // IntegroGrepFactory.ACS_RestPath.regularExpression;
        ...
        public void testImmediatelyAfter() throws StringParseException {
                ...
                assertThat("We should have two entries", l_currentValues.keySet(),
                                Matchers.containsInAnyOrder("section", "product"));

                assertThat("We should have the correct value for section", l_currentValues.get("section"),
                                is(equalTo("qa")));

                assertThat("We should have the correct value for product", l_currentValues.get("product"),
                                is(equalTo("campaign")));
        ...
        public void testCreateApacheProfileFile_storeFile()
                ...
                l_entries.get("amcDataSource/AMCDS745177#GET").fetchValuesAsList().stream()
        ...
        public void testEndPositionCaseInsensitive() {
                String logString = "+69802:5ee7914c:15|POST /nl/jsp/soaprouter.jsp HTTP/1.1|X-Security-Token:@tTD6JQ5HcTfzCWt5OkJcJ_BfmC8mfw==|soapaction:xtk%3aqueryDef#ExecuteQuery|Content-Length:591|Content-Type:text/plain; charset=ISO-8859-1|Host:rd-dev54.rd.campaign.adobe.com|Connection:Keep-Alive|User-Agent:Apache-HttpClient/4.5.2 (Java/1.8.0_171)|Cookie:__sessiontoken=___6fffa340-b973-4e90-a965-4ae88e713c11|Accept-Encoding:gzip,deflate";
        ...
        public void testEndPositionCaseInsensitive_searchStringDifferentCase() {
                ...
                l_definitionCS.setTitle("path");
                l_definitionCS.setStart("HTTP/1.1|");
                l_definitionCS.setEnd("|Content-Length");
                l_definitionCS.setCaseSensitive(true);
        ...
        @Test(description = "Related to issue #103, where the parsing stops or no reason")
        public void testSkipOnLimit_Issue103()
                        throws StringParseException {
                ...
                ParseGuardRails.FILE_ENTRY_LIMIT = 10;

                assertThat("We should have the correct value for the file entry limit",
                                ParseGuardRails.FILE_ENTRY_LIMIT, is(equalTo(10)));
        ...
        @Test(description = "Related to issue #102, where the parsing stops or no reason")
        public void testFileInterruption2()
                        throws StringParseException {
        ...
        public void testReplacementCorresponds_1part_issueWithDot() {
                ...
                // assertThat("we should get the same value",
                // StringParseFactory.fetchCorresponding(l_storedString,l_candidateString2),
                // Matchers.equalTo(l_storedString));
                assertThat("we should get the same value",
                                StringParseFactory.anonymizeString(l_storedString, l_candidateString),
                                Matchers.equalTo(l_candidateString));
